...
def getCommonSense(utterance):
	os.system('python comet-commonsense/scripts/generate/generate_conceptnet_arbitrary.py --model_file pretrained_models/conceptnet_pretrained_model.pickle --input "'+utterance+'" --output_file output.json --device 0 --sampling_algorithm beam-5')
